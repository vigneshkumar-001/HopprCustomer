...
import 'package:hopper/Presentation/OnBoarding/Controller/upload_image_controller.dart';
...
class  SharedChatScreens  extends StatefulWidget {
  ...
  @override
  State<SharedChatScreens> createState() => _SharedChatScreensState();
}

class _SharedChatScreensState extends State<SharedChatScreens> {
                      ...
                      Expanded(
                        child: TextField(
                          onChanged: (val) {
                            ...
                            rideShareSocket.emit('typing', data);
                          },
